...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
  var multiplicarPorCinco =  objetoMisterioso.numeroMisterioso*5;
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   var usuarioPremium = objetoMuchosUsuarios
   for(i = 0; i<usuarioPremium.length; i++){
   if(usuarioPremium[i].esPremium !== true) usuarioPremium[i].esPremium = true;
